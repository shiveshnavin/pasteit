...
<table style="width:100%; background-color: #efefef;   ">
    ...
    <tr>
        ...
        <th> <a href='http://35.206.65.195:3000/'>
                <h2>UPLOAD</h2>
            </a> </th>
        <th> <a href='http://hoptech.in/save.php'>
                <h2>SAVE</h2>
            </a> </th>
        <th> <a href='http://35.206.65.195:3000/secure'>
                <h2>Secure-SAVE</h2>
            </a> </th>
    ...
    <table id="clip" style="width:100%">
        ...
        foreach ($clips as $v) {
            ...
            if ($v["type"] == 'link')
                ...
                <td style="display:block;text-align:center"> <a class="button red" href="?del=%s">DELETE</a><br><br><br><a class="button green" href="?view=%s">CHECK</a></td>',
                    $v["blob"],
                    $v["blob"],
                    $v["date"],
                    $v["id"],
                ...
                <td style="text-align:center">%s</td>
                <td style="display:block;text-align:center"><a class="button red" href="?del=%s">DELETE</a><br><br><br><a class="button green" href="?view=%s">CHECK</a></td>', str_replace('\n', '<br>', $v["blob"]), $v["date"], $v["id"], $v["id"]);
...
function write($blob, $type, $user)
{
    ...
    $mysqli = mysqlc();
    $sql = sprintf(
        'INSERT INTO   `clip` (`type`,`blob`,`user`) VALUES ("%s","%s","%s");',
